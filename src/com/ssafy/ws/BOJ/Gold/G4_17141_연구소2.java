...
class Node17141 {
    ...
    Node17141(int x, int y, int time) {
        this.x = x;
        this.y = y;
        this.time = time;
    }
...
public class G4_17141_연구소2 {
    ...
    static List<Node17141> virus = new ArrayList<>();
    ...
    private static void bfs() {
        ...
        Queue<Node17141> q = new LinkedList<>();
        for (int i = 0; i < m; i++) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (nx >= 0 && ny >= 0 && nx < n && ny < n) {
                    ...
                    if (!visited[nx][ny] && copymap[nx][ny] == 0) {
                        ...
                        copymap[nx][ny] = 2;
                        // 다음 퍼질 곳 넣고 큐 돌려
                        q.add(new Node17141(nx, ny, a.time + 1));
                    }
                }
            }
        }
